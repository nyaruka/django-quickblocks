...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuickBlockType.has_link'
        db.add_column('django_quickblocks_quickblocktype', 'has_link',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuickBlockType.has_link'
        db.delete_column('django_quickblocks_quickblocktype', 'has_link')
