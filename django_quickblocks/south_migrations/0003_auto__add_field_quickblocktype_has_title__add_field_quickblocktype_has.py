...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuickBlockType.has_title'
        db.add_column('django_quickblocks_quickblocktype', 'has_title',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'QuickBlockType.has_tags'
        db.add_column('django_quickblocks_quickblocktype', 'has_tags',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuickBlockType.has_title'
        db.delete_column('django_quickblocks_quickblocktype', 'has_title')

        # Deleting field 'QuickBlockType.has_tags'
        db.delete_column('django_quickblocks_quickblocktype', 'has_tags')
    ...
    models = {
        ...
        'django_quickblocks.quickblocktype': {
            ...
            'has_tags': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
