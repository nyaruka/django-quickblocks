...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuickBlockImage'
        db.create_table('django_quickblocks_quickblockimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quickblock', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['django_quickblocks.QuickBlock'])),
        ...
        db.send_create_signal('django_quickblocks', ['QuickBlockImage'])


    def backwards(self, orm):
        # Deleting model 'QuickBlockImage'
        db.delete_table('django_quickblocks_quickblockimage')
